...
func (*ActionMeta_Extensions_Apis) Descriptor() ([]byte, []int) {
	return file_extensions_proto_rawDescGZIP(), []int{2, 1, 0}
}
...
func (*ActionMeta_Extensions_Apigateway) Descriptor() ([]byte, []int) {
	return file_extensions_proto_rawDescGZIP(), []int{2, 1, 1}
}
...
func (*ActionMeta_Extensions_Nodegroups) Descriptor() ([]byte, []int) {
	return file_extensions_proto_rawDescGZIP(), []int{2, 1, 2}
}
...
func (*ActionMeta_Extensions_Eks) Descriptor() ([]byte, []int) {
	return file_extensions_proto_rawDescGZIP(), []int{2, 1, 3}
}
...
var file_extensions_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x43, 0x0a, 0x10, 0x57, 0x65, 0x62, 0x73, 0x6f, 0x63, 0x6b, 0x65, 0x74, 0x4d,
	...
	0x6c, 0x48, 0x00, 0x52, 0x07, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x42, 0x09, 0x0a, 0x07,
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xad, 0x02, 0x0a, 0x07, 0x49, 0x6e, 0x73, 0x74,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xd2, 0x06, 0x0a, 0x0a, 0x41, 0x63, 0x74, 0x69,
...
var file_extensions_proto_goTypes = []interface{}{
	...
	(*ActionMeta)(nil),                       // 2: ActionMeta
	(*Install_Applications)(nil),             // 3: Install.Applications
	nil,                                      // 4: Install.Applications.VariablesEntry
	(*ActionMeta_Services)(nil),              // 5: ActionMeta.Services
	(*ActionMeta_Extensions)(nil),            // 6: ActionMeta.Extensions
	(*ActionMeta_Extensions_Apis)(nil),       // 7: ActionMeta.Extensions.Apis
	(*ActionMeta_Extensions_Apigateway)(nil), // 8: ActionMeta.Extensions.Apigateway
...
var file_extensions_proto_depIdxs = []int32{
	...
	3,  // 1: Install.applications:type_name -> Install.Applications
	5,  // 2: ActionMeta.services:type_name -> ActionMeta.Services
	6,  // 3: ActionMeta.extensions:type_name -> ActionMeta.Extensions
	4,  // 4: Install.Applications.variables:type_name -> Install.Applications.VariablesEntry
	10, // 5: ActionMeta.Extensions.eks:type_name -> ActionMeta.Extensions.Eks
	8,  // 6: ActionMeta.Extensions.apis:type_name -> ActionMeta.Extensions.Apigateway
	7,  // 7: ActionMeta.Extensions.Apigateway.apis:type_name -> ActionMeta.Extensions.Apis
