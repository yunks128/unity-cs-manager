...
- [Issue tracking system](https://github.com/unity-sds/unity-cs-terraform-transformer/issues) - a regularly monitored area to report issues with our software or propose changes
...
See our list of issues at: [https://github.com/unity-sds/unity-cs-terraform-transformer/issues]
...
- **Check for duplicates** - there may be a bug report already describing your issue, so check the [issue tracking system](https://github.com/unity-sds/unity-cs-terraform-transformer/issues) first

Here's some guidance on submitting a bug issue:
1. Navigate to our [issue tracking system](https://github.com/unity-sds/unity-cs-terraform-transformer/issues) and file a new issue
...
- **Check for duplicates** - there may be a new feature issue already describing your issue, so check the [issue tracking system](https://github.com/unity-sds/unity-cs-terraform-transformer/issues) first
...
Take a look at our [pull requests tracking system](https://github.com/unity-sds/unity-cs-terraform-transformer/pulls), and try the following options for providing a review:
...
⚠️ It's **highly** advised that you take a look at our [issue tracking system](https://github.com/unity-sds/unity-cs-terraform-transformer/issues) before considering any code contributions. Here's some guidelines:
...
⚠️ It's **highly** advised that you take a look at our [issue-tracking system](https://github.com/unity-sds/unity-cs-terraform-transformer/issues) before considering any documentation contributions. Here's some guidelines:
...
- Answer open questions mentioned in our [issue tracking system](https://github.com/unity-sds/unity-cs-terraform-transformer/issues)
